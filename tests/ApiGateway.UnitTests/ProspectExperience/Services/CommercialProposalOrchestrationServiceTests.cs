...
public class CommercialProposalOrchestrationServiceTests
{
    ...
    {
        _prospectApiClient
            .Setup(c => c.GetCommercialProposalEligibilityAsync(AccountId, CurrentUserId, It.IsAny<CancellationToken>()))
    ...
    public async Task SendAsync_WhenEligibleAndAccountFound_UploadsToRegistryThenCallsProspect()
    {
        ...
        _registryProspectClient
            ...
            .ReturnsAsync(true);
        _prospectApiClient
            .Setup(c => c.SendCommercialProposalAsync(AccountId, CurrentUserId, ContactEmail, fileMock.Object, It.IsAny<CancellationToken>()))
            .Returns(Task.CompletedTask);
        ...
        _prospectApiClient.Verify(
            c => c.SendCommercialProposalAsync(AccountId, CurrentUserId, ContactEmail, fileMock.Object, It.IsAny<CancellationToken>()),
            Times.Once);
    }
